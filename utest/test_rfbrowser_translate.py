...
from Browser.entry.translation import MISSING_CHECKSUM, _get_heading, _table_doc_updated, DOC_CHANGED, NO_LIB_KEYWORD, MISSING_TRANSLATION
...
def test_body_line():
    verify_all("body", [
        ...
        _table_doc_updated("this_is_long_keyword_which_is_42_chars_len", 42, MISSING_TRANSLATION),
...
def test_full_long_kw_table():
    ...
    lines.append(_table_doc_updated("this_is_long_keyword_which_is_42_chars_len", 42, MISSING_TRANSLATION))
