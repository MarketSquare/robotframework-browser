...
library 19.14.1 fixes release process. All issues targeted for Browser library
v19.14.1 can be found from the
[issue tracker](https://github.com/MarketSquare/robotframework-browser/issues?q=state%3Aclosed%20milestone%3Av19.14.1).
...
install it manually. Browser library 19.14.1 was released on Monday April 6, 2026.
...
Fixing release process, which requires new release.
...
Altogether 1 issue. View on the [issue tracker](https://github.com/MarketSquare/robotframework-browser/issues?q=milestone%3Av19.14.1).
