...
goog.exportSymbol('proto.selectOptionRequest', null, global);
 ...
 * @constructor
 */
proto.selectOptionRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.selectOptionRequest.repeatedFields_, null);
};
goog.inherits(proto.selectOptionRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.selectOptionRequest.displayName = 'proto.selectOptionRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.selectOptionRequest.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.selectOptionRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.selectOptionRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.selectOptionRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.selectOptionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    selector: jspb.Message.getFieldWithDefault(msg, 1, ""),
    matcherList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.selectOptionRequest}
 */
proto.selectOptionRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.selectOptionRequest;
  return proto.selectOptionRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.selectOptionRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.selectOptionRequest}
 */
proto.selectOptionRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.selectOptionRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.selectOptionRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.selectOptionRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.selectOptionRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSelector();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.selectOptionRequest.prototype.getSelector = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.selectOptionRequest} returns this
 */
proto.selectOptionRequest.prototype.setSelector = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Array<string>}
 */
proto.selectOptionRequest.prototype.getMatcherList = function() {
 ...
 * @return {!proto.selectOptionRequest} returns this
 */
proto.selectOptionRequest.prototype.setMatcherList = function(value) {
 ...
 * @return {!proto.selectOptionRequest} returns this
 */
proto.selectOptionRequest.prototype.addMatcher = function(value, opt_index) {
 ...
 * @return {!proto.selectOptionRequest} returns this
 */
proto.selectOptionRequest.prototype.clearMatcherList = function() {
 ...
 * @return {string}
 */
proto.SelectEntry.prototype.getLog = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.SelectEntry.prototype.setLog = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
