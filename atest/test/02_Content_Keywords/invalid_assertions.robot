...
Invalids will raise error directly from Robot Framework
    ...
    ...    faultyOps
    run keyword and expect error
    ...    *'assertion_operator' got value '!=!' that cannot be converted to AssertionOperator*    get_text    h1
    ...    !=!    blaah
    run keyword and expect error
    ...    *'assertion_operator' got value 'huh' that cannot be converted to AssertionOperator*    Get Textfield Value
    ...    css=input#username_field    huh    hah
