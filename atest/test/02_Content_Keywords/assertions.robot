...
Less
    ...
    Get Style    //*[@id="progress"]    width    lessthan    401
...
Starts With
    ...
    Get Title    shouldstartwith    Log
    
Ends With
    Get Title    $=    ge
    Get Title    shouldendwith    ge
