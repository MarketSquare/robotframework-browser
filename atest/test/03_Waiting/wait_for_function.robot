...
Failed Wait For Function Promise
    ${promise}    Promise To    Wait For Function    (selector) => {console.log(selector.toString()); return document.activeElement === selector}    selector=\#username_field    timeout=100ms
